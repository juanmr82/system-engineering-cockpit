...
describe('AccessCategories', () => {
  ...
  async function setUp(): Promise<void> {
    ...
    // AccessApiService is providedIn: 'root' and constructs groups/unassignedContainers/defaults
    // alongside categories on injection; this view reads none of them, but every stray request
    // still has to be flushed here or verify() sees it hanging (the same trap step 8's own
    // handover entry names — check this again whenever AccessApiService grows another resource).
