...
`docs/jira-issues-dynamic-view-design.md` specifies importing JIRA issues into Neo4j and exposing
them as a configurable table. Two things about it do not fit the shape this product already has,
and both were settled deliberately rather than discovered later.
